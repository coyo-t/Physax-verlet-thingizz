...
function MapRenderer (_map/*Map*/) constructor begin
	...
	layers = array_create_ext(BlockRenderLayerIndex.SIZEOF, cb)
	
	dirty = true
	
	current_colour/*Colour*/ = c_white
	current_alpha/*Value*/ = 1.0
	...
	static vertex = function (_x/*Value*/, _y/*Value*/)
	{
...
interface MapChangeListener begin
	block_changed (_x:Int, _y:Int, _from:Block, _to:Block)
end
*/
...
function Map (_wide/*Int*/, _tall/*Int*/) constructor begin
	...
	listener/*MapChangeListener*/ = undefined
	...
	static get_colliders = function (box/*Rect*/, predicate/*BlockAreaPredicate*/=undefined)/*Array<Rect>*/
	{
		static TEMP = rect_create(0,0,0,0)
		static DEFAULT_PREDICATE = function (_bloc, _shape, _x, _y) { return true }
	...
	static point_in_bounds = function (_x/*Value*/, _y/*Value*/)/*Boolean*/
	{
