...
function Block () constructor {
	...
	runtime_id = 0 ///@is {int}
	name = "" ///@is {string}
	colour = c_white ///@is {int}
	
	shape = rect_create(0, 0, 1, 1) ///@is {Rect}
	
	static drawable = function () /*-> bool*/ { return true }

	static show_in_palette = function () /*-> bool*/ { return true }
	
	static collideable = function () /*-> bool*/ { return true }
...
function AirBlock () : Block() constructor begin
	...
	static drawable = function () /*-> bool*/ { return false }
	
	static show_in_palette = function () /*-> bool*/ { return false }

	static collideable = function () /*-> bool*/ { return false }
end
